...
@implementation Velvet3AppearanceStackView
...
@implementation Velvet3AppearanceCell

- (Velvet3AppearanceCell *)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
    ...
    if (self) {
        ...
        for (NSDictionary *option in self.options) {
            ...
            Velvet3AppearanceStackView *stackView = [[Velvet3AppearanceStackView alloc] initWithType:option[@"value"]
                                                                                  forController:self 
                                                                                  withImage:image
                                                                                  andText:option[@"text"]
...
- (void)updateSelected:(NSString *)value {
    for (Velvet3AppearanceStackView *subview in self.containerStackView.arrangedSubviews) {
...
-(void)didMoveToSuperview {
    ...
    if ([controller isKindOfClass:NSClassFromString(@"Velvet3PreviewController")]) {
        Velvet3PreviewController *previewController = (Velvet3PreviewController *)controller;
