...
@implementation Velvet3AppSelectController
...
-(void)showController:(id)controller {
	if ([controller isKindOfClass:NSClassFromString(@"Velvet3SettingsController")]) {
        ...
        ((Velvet3SettingsController *)controller).identifier = specifier.properties[@"key"];
		((Velvet3SettingsController *)controller).identifierName = specifier.name;
	}
